...
import { Notes_Sidebar_Setting, Interview_Sidebar_Setting, Problems_Sidebar_Setting } from './utils/constant'
...
const sidebar_all = [...Notes_sidebar, ...Interview_sidebar, ...Problems_sidebar]
