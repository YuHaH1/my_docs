...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>浏览器和客户是一对一，因此不会出现公用一个实例问题。</p><p>因此为了避免交叉感染，在组件内不要使用全局变量</p>`,28);function h(w,C){const o=a("ExternalLinkIcon"),e=a("CommentService");return l(),i("div",null,[k,n("ul",null,[d,v,n("li",null,[s("Vue3允许自定义渲染器，扩展能力强。不会发生以前的事情，改写Vue源码改造渲染方式。"),m,s("。"),n("a",b,[s("自定义渲染器文档"),p(o)])]),g,f]),y,p(e)])}const D=c(r,[["render",h],["__file","Vue面经.html.vue"]]);export{D as default};
