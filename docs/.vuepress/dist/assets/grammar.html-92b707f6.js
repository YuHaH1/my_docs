import{_ as n,M as a,p as e,q as p,N as t,a1 as o}from"./framework-f7ec573f.js";const l={},c=o(`<ol><li><p>typeof 取对象身上的类型</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">const</span> person <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></li></ol></li></ol>`,1);function i(r,k){const s=a("CommentService");return e(),p("div",null,[c,t(s)])}const d=n(l,[["render",i],["__file","grammar.html.vue"]]);export{d as default};
