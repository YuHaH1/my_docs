import{_ as s,M as a,p as e,q as p,N as t,a1 as c}from"./framework-a97ca956.js";const o="/Sass/for_each.png",i="/Sass/mixin_include.gif",l={},u=c(`<h1 id="sass" tabindex="-1"><a class="header-anchor" href="#sass" aria-hidden="true">#</a> Sass</h1><h2 id="_1、-extend" tabindex="-1"><a class="header-anchor" href="#_1、-extend" aria-hidden="true">#</a> 1、@extend</h2><p>一个元素使用的样式与另一个元素完全相同，但又添加了额外的样式。</p><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">.a</span><span class="token punctuation">{</span>
