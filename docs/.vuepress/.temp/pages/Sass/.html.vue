<template><div><h1 id="sass" tabindex="-1"><a class="header-anchor" href="#sass" aria-hidden="true">#</a> Sass</h1>
<h2 id="_1、-extend" tabindex="-1"><a class="header-anchor" href="#_1、-extend" aria-hidden="true">#</a> 1、@extend</h2>
<p>一个元素使用的样式与另一个元素完全相同，但又添加了额外的样式。</p>
<div class="language-scss line-numbers-mode" data-ext="scss"><pre v-pre class="language-scss"><code><span class="token selector">.a</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2、-if-else-if-else" tabindex="-1"><a class="header-anchor" href="#_2、-if-else-if-else" aria-hidden="true">#</a> 2、@if  @else if @else</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3、循环-for-while" tabindex="-1"><a class="header-anchor" href="#_3、循环-for-while" aria-hidden="true">#</a> 3、循环@for @while</h2>
<blockquote>
<h5 id="for" tabindex="-1"><a class="header-anchor" href="#for" aria-hidden="true">#</a> @for</h5>
</blockquote>
<p><code v-pre>@for</code> 指令可以在限制的范围内重复输出格式，每次按要求（变量的值）对输出结果做出变动。这个指令包含两种格式：<code v-pre>@for $var from &lt;start&gt; through &lt;end&gt;</code>，或者 <code v-pre>@for $var from &lt;start&gt; to &lt;end&gt;</code>，区别在于 <code v-pre>through</code> 与 <code v-pre>to</code> 的含义：<em>当使用 <code v-pre>through</code> 时，条件范围包含 <code v-pre>&lt;start&gt;</code> 与 <code v-pre>&lt;end&gt;</code> 的值，而使用 <code v-pre>to</code> 时条件范围只包含 <code v-pre>&lt;start&gt;</code> 的值不包含 <code v-pre>&lt;end&gt;</code> 的值</em>。另外，<code v-pre>$var</code> 可以是任何变量，比如 <code v-pre>$i</code>；<code v-pre>&lt;start&gt;</code> 和 <code v-pre>&lt;end&gt;</code> 必须是整数值。</p>
...
<h5 id="while" tabindex="-1"><a class="header-anchor" href="#while" aria-hidden="true">#</a> @while</h5>
</blockquote>
<p><code v-pre>@while</code> 指令重复输出格式直到表达式返回结果为 <code v-pre>false</code>。这样可以实现比 <code v-pre>@for</code> 更复杂的循环，只是很少会用到。例如：</p>
<div class="language-scss line-numbers-mode" data-ext="scss"><pre v-pre class="language-scss"><code><span class="token property"><span class="token variable">$i</span></span><span class="token punctuation">:</span> 6<span class="token punctuation">;</span>
...
<span class="token selector">.item-2 </span><span class="token punctuation">{</span>
  <span class="token property">width</span><span class="token punctuation">:</span> 4em<span class="token punctuation">;</span> <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4、-each" tabindex="-1"><a class="header-anchor" href="#_4、-each" aria-hidden="true">#</a> 4、@each</h2>
<p>each相当于for in，能够遍历一个列表。</p>
<p><code v-pre>@each</code> 指令的格式是 <code v-pre>$var in &lt;list&gt;</code>, <code v-pre>$var</code> 可以是任何变量名，比如 <code v-pre>$length</code> 或者 <code v-pre>$name</code>，而 <code v-pre>&lt;list&gt;</code> 是一连串的值，也就是值列表。</p>
<div class="language-scss line-numbers-mode" data-ext="scss"><pre v-pre class="language-scss"><code><span class="token keyword">@each</span> <span class="token selector"><span class="token variable">$var</span> in -1,-2,-3</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="/Sass/for_each.png" alt=""></p>
<h2 id="_5、mixin混合-include引入混合" tabindex="-1"><a class="header-anchor" href="#_5、mixin混合-include引入混合" aria-hidden="true">#</a> 5、<strong><u>Mixin混合</u></strong> @include引入混合</h2>
<p>混合指令（Mixin）用于定义可重复使用的样式，避免了使用无语意的 class，比如 <code v-pre>.float-left</code>。混合指令可以包含所有的 CSS 规则，绝大部分 Sass 规则，甚至通过参数功能引入变量，输出多样化的样式。</p>
<p>使用 <code v-pre>@include</code> 指令引用混合样式，格式是在其后添加混合名称，以及需要的参数（可选）：</p>
<div class="language-scss line-numbers-mode" data-ext="scss"><pre v-pre class="language-scss"><code><span class="token keyword">@mixin</span> <span class="token selector">center_hover</span><span class="token punctuation">{</span>
...
<span class="token selector">.a</span><span class="token punctuation">{</span>
    ...
    <span class="token selector">.b</span><span class="token punctuation">{</span>
        ...
        <span class="token property">background-color</span><span class="token punctuation">:</span> orangered<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-2、向混入中导入内容-content" tabindex="-1"><a class="header-anchor" href="#_5-2、向混入中导入内容-content" aria-hidden="true">#</a> 5.2、向混入中导入内容@content</h3>
<p><u>类似于插槽</u></p>
<p>在引用混合样式的时候，可以先将一段代码导入到混合指令中，然后再输出混合样式，额外导入的部分将出现在 <code v-pre>@content</code> 标志的地方：</p>
<div class="language-scss line-numbers-mode" data-ext="scss"><pre v-pre class="language-scss"><code><span class="token keyword">@mixin</span> content_<span class="token function">margin</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<div class="language-scss line-numbers-mode" data-ext="scss"><pre v-pre class="language-scss"><code><span class="token keyword">@function</span> computed_<span class="token function">width</span><span class="token punctuation">(</span><span class="token variable">$n</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7、关键词" tabindex="-1"><a class="header-anchor" href="#_7、关键词" aria-hidden="true">#</a> 7、关键词</h2>
<h3 id="_7-1、插值语句" tabindex="-1"><a class="header-anchor" href="#_7-1、插值语句" aria-hidden="true">#</a> 7.1、插值语句<code v-pre>#{}</code></h3>
<p><code v-pre>#{}</code>插值语句：通过 <code v-pre>#{}</code> 插值语句可以在选择器或属性名中使用变量：</p>
<ol>
<li>
<div class="language-scss line-numbers-mode" data-ext="scss"><pre v-pre class="language-scss"><code><span class="token property"><span class="token variable">$name</span></span><span class="token punctuation">:</span> foo<span class="token punctuation">;</span>
...
<h3 id="_7-2、父级元素选择器" tabindex="-1"><a class="header-anchor" href="#_7-2、父级元素选择器" aria-hidden="true">#</a> 7.2、父级元素选择器&amp;</h3>
<p>&amp;<code v-pre>参考当前元素的父元素选择器，当父元素不存在</code>&amp;`将为null</p>
<p>如果父元素是<code v-pre>a</code>,下面代码就是<code v-pre>a:hover</code></p>
