<template><div><h1 id="vue内置组件" tabindex="-1"><a class="header-anchor" href="#vue内置组件" aria-hidden="true">#</a> Vue内置组件</h1>
<h2 id="_1-transition组件" tabindex="-1"><a class="header-anchor" href="#_1-transition组件" aria-hidden="true">#</a> 1.Transition组件</h2>
<p>实现原理：在元素被挂载前，将动效添加到该DOM上，当元素卸载时，先将动效执行完再卸载。</p>
<div class="language-css line-numbers-mode" data-ext="css"><pre v-pre class="language-css"><code><span class="token selector">.enter-from</span><span class="token punctuation">{</span>
...
<p>由于浏览器会在当前帧绘制DOM，因此<code v-pre>enter-to</code>的样式会绘制出来而不会绘制<code v-pre>enter-form</code>，解决办法是将移除<code v-pre>enter-from</code>添加<code v-pre>enter-to</code>的动效放在下一帧去执行这里利用<code v-pre>requestAnimationFrame</code>，。然后监听<code v-pre>transitionend</code>动效结束事件，结束后移除<code v-pre>enter-to</code>和<code v-pre>enter-active</code></p>
</div>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>el<span class="token punctuation">.</span>classList<span class="token punctuation">.</span><span class="token function">add</span><span class="token punctuation">(</span><span class="token string">'enter-from'</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Vue提供三个钩子<code v-pre>beforeEnter，enter，leave</code>钩子</p>
<p>在挂载元素之前的时候判断是否VNode需要过渡，如果需要就执行<code v-pre>vnode.transition.beforeEnter</code>,挂载后会调用<code v-pre>enter</code>钩子，卸载元素的时候执行<code v-pre>leave</code></p>
<h2 id="_2-keepalive组件" tabindex="-1"><a class="header-anchor" href="#_2-keepalive组件" aria-hidden="true">#</a> 2.KeepAlive组件</h2>
<p>KeepAlive原理</p>
<ul>
<li>该组件会给默认插槽缓存下来</li>
<li>并注入<code v-pre>deactivated</code>和<code v-pre>activate</code>两个钩子</li>
<li>在VNode身上设置<code v-pre>shouldKeepAlive</code>，在卸载组件时调用<code v-pre>deactivate</code>方法</li>
<li>如果VNode已经被缓存了就会被添加上<code v-pre>KeptAlive</code>标记，渲染器在看到该属性会执行<code v-pre>activate</code>激活</li>
</ul>
<p>对于deactivate和activate，Vue会创建一个隐藏容器，在deactivate时将VNode放到容器中，</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>deactivate <span class="token operator">-</span><span class="token operator">></span><span class="token function">move</span><span class="token punctuation">(</span>vnode<span class="token punctuation">,</span>storageContainer<span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>源码当页面创建时初始化缓存的变量</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code>  <span class="token function">created</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当页面挂载后缓存VNode并观察用户是否传入了include/exclude</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token function">mounted</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token function">updated</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">cacheVNode</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>cacheVNode源码</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code>  methods<span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>render方法</p>
<ul>
<li>
<p><code v-pre>render</code>中出路<code v-pre>include</code>和<code v-pre>exclude</code>逻辑判断默认情况<code v-pre>KeepAlive</code>会缓存所有内部组件，但用户可以指定哪些不被缓存或者只缓存哪些组件。</p>
<p><code v-pre>include</code>和<code v-pre>exclude</code>是正则/组件名/数组[组件名]，会根据该内容来匹配组件名</p>
</li>
</ul>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code>  <span class="token function">render</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">matches</span><span class="token punctuation">(</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>KeepAlive使用字典，键存vnode的type，值是Vnode。<strong>缓存会设置一个阈值，防止当该VNode没缓存时，一直设置新缓存，占大量内存。</strong></p>
<p>LRU，最近一次访问算法。通过设置max为缓存的最大容量。当容量满了后开始修剪，最近访问的不会删除，移除最长时间没有使用的缓存。</p>
<p>得到根节点的方法</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">getFirstComponentChild</span><span class="token punctuation">(</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>得到组件名的方法</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">getComponentName</span><span class="token punctuation">(</span>options<span class="token operator">:</span> ComponentOptions<span class="token punctuation">)</span> <span class="token punctuation">{</span>
