...
<p>名字概念：</p>
<p><strong>度</strong>：节点拥有的最大分支数量就是树的度。</p>
<p><strong>叶子/终端节点</strong>：没有子节点节点。</p>
<p><strong>树的深度</strong>：树的高度</p>
<p><strong>森林</strong>：m（m》=0）颗互不相交的树的集合（树一定是森林，森林不一定是树）</p>
<p><strong>二叉树</strong>：每个节点最多两个分支（也就是说不存在度大于2的结点）</p>
<h3 id="二叉树的一些性质" tabindex="-1"><a class="header-anchor" href="#二叉树的一些性质" aria-hidden="true">#</a> 二叉树的一些性质</h3>
<ol>
<li>
<p>在第i层最多有结点数量如下</p>
<p><span class="katex-display"><span class="katex"><span class="katex-mathml"><math><semantics><mrow><msup><mn>2</mn><mrow><mi>i</mi><mo>−</mo><mn>1</mn></mrow></msup></mrow><annotation encoding="application/x-tex">2^{i-1}
</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.874664em;"></span><span class="strut bottom" style="height:0.874664em;vertical-align:0em;"></span><span class="base displaystyle textstyle uncramped"><span class="mord"><span class="mord mathrm">2</span><span class="vlist"><span style="top:-0.41300000000000003em;margin-right:0.05em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle uncramped"><span class="mord scriptstyle uncramped"><span class="mord mathit">i</span><span class="mbin">−</span><span class="mord mathrm">1</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span></span></p>
</li>
<li>
<p>深度为K的二叉树最多有结点数量如下，最少有K个结点</p>
<p><span class="katex-display"><span class="katex"><span class="katex-mathml"><math><semantics><mrow><msup><mn>2</mn><mi>k</mi></msup><mo>−</mo><mn>1</mn></mrow><annotation encoding="application/x-tex">2^k-1
</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.8991079999999999em;"></span><span class="strut bottom" style="height:0.9824379999999999em;vertical-align:-0.08333em;"></span><span class="base displaystyle textstyle uncramped"><span class="mord"><span class="mord mathrm">2</span><span class="vlist"><span style="top:-0.413em;margin-right:0.05em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle uncramped"><span class="mord mathit" style="margin-right:0.03148em;">k</span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span><span class="mbin">−</span><span class="mord mathrm">1</span></span></span></span></span></p>
</li>
<li>
<p>叶子节点数为n0，度为2的节点数为n2</p>
</li>
</ol>
<p><span class="katex-display"><span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>n</mi><mrow><mn>0</mn></mrow></msub><mo>=</mo><msub><mi>n</mi><mrow><mn>2</mn></mrow></msub><mo>+</mo><mn>1</mn></mrow><annotation encoding="application/x-tex">n_{0}=n_{2}+1
</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.64444em;"></span><span class="strut bottom" style="height:0.79444em;vertical-align:-0.15em;"></span><span class="base displaystyle textstyle uncramped"><span class="mord"><span class="mord mathit">n</span><span class="vlist"><span style="top:0.15em;margin-right:0.05em;margin-left:0em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathrm">0</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span><span class="mrel">=</span><span class="mord"><span class="mord mathit">n</span><span class="vlist"><span style="top:0.15em;margin-right:0.05em;margin-left:0em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathrm">2</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span><span class="mbin">+</span><span class="mord mathrm">1</span></span></span></span></span></p>
<p><img src="/Algorithms/leaf.png" alt=""></p>
<p>总结点数n = n2 × 2 + n1 × 1 +1 = n2 + n1 + n0 （这是推导过程）</p>
<h3 id="森林和二叉树转换" tabindex="-1"><a class="header-anchor" href="#森林和二叉树转换" aria-hidden="true">#</a> 森林和二叉树转换</h3>
<p><strong>森林转二叉树</strong></p>
<p>兄弟相连留长子，树变二叉根相连，保留根，将根的兄弟旋转45度（旋转45就是变右孩）</p>
<p><img src="/Algorithms/Ttree.png" alt=""></p>
<p><strong>二叉树转森林</strong></p>
<p>去掉全部右孩线，左孩的右孩子变兄弟，右孩子的右孩子也变左孩子兄弟</p>
<p><img src="/Algorithms/Ttree2.png" alt=""></p>
<p>​</p>
<p>​</p>
<h3 id="哈夫曼树" tabindex="-1"><a class="header-anchor" href="#哈夫曼树" aria-hidden="true">#</a> 哈夫曼树</h3>
<p>给定N个权值作为N个叶子结点，构造一棵二叉树，<strong>若该树的带权路径长度达到最小</strong>，称这样的二叉树为<code v-pre>最优二叉树</code>，也称为<code v-pre>哈夫曼树(Huffman Tree)</code>。哈夫曼树是带权路径长度最短的树，权值较大的结点离根较近。</p>
<p><strong>哈夫曼树的结点度只有0或2没有度为1的结点；包含n个叶子结点的哈夫曼树共有2n-1个结点</strong></p>
<p><img src="/Algorithms/hafuman.png" alt=""></p>
<p>构造哈夫曼树的步骤</p>
<ol>
<li>根据n个权值构造n个根节点</li>
<li>选用两个最小的权值，作为左右子树，根节点权值为两小权值的和</li>
<li>然后将（2）造的树添加上，重复2 3</li>
</ol>
<p><img src="/Algorithms/hafuman2.png" alt=""></p>
...
<p>两两比较将大的放后面，每一次排序后都能够将最大的元素不断放到后面像冒泡一样。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="快排" tabindex="-1"><a class="header-anchor" href="#快排" aria-hidden="true">#</a> 快排</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="直接插入排序" tabindex="-1"><a class="header-anchor" href="#直接插入排序" aria-hidden="true">#</a> 直接插入排序</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>        <span class="token keyword">function</span> <span class="token function">insertSort</span><span class="token punctuation">(</span><span class="token parameter">arr</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="选择排序-堆排序" tabindex="-1"><a class="header-anchor" href="#选择排序-堆排序" aria-hidden="true">#</a> 选择排序（堆排序）</h3>
<p>小/大根堆</p>
<ol>
<li>输出堆顶元素（根节点）</li>
<li>根节点值与左右子树的根节点值进行比较，并与其中小的进行交换、</li>
<li>重复上面步骤直到叶子节点</li>
</ol>
<p>每次选择最大/最小放在前面</p>
<p><img src="/Algorithms/dui.png" alt=""></p>
<h3 id="基数排序" tabindex="-1"><a class="header-anchor" href="#基数排序" aria-hidden="true">#</a> 基数排序</h3>
<p>思想：先设置0-9个桶，然后将数字按位排序，从个位到十位。。。基数排序只能对数字进行排序</p>
<p>例如  17   21  32  53  94  50  31</p>
<p>第一次排序按照个位  50  21 31 32 53 94 17</p>
<table>
<thead>
<tr>
...
<p>第二次排序按照十位  17 21 31 32 50 53 94</p>
<table>
<thead>
<tr>
<th style="text-align:center">0</th>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="希尔排序" tabindex="-1"><a class="header-anchor" href="#希尔排序" aria-hidden="true">#</a> 希尔排序</h3>
<p><img src="/Algorithms/xier.png" alt=""></p>
<p>把数组按照一定的增量分组，对每组使用直接插入排序算法排序，希尔建议的间距是N/2，每一趟排序分成两半，也就是说，对于N=10的数组，增量间隔序列为5、2、1；</p>
<p>然后缩小增量继续分组排序；随着增量逐渐减少，每组包含的关键词越来越多，当增量减至1时，整个数组被分成一组，再次排序，就可以完成整个数组的排序；</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>
