<template><div><h1 id="sequelize" tabindex="-1"><a class="header-anchor" href="#sequelize" aria-hidden="true">#</a> sequelize</h1>
<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 这将安装 v6 最新版本的 Sequelize</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token punctuation">{</span> Sequelize <span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'@sequelize/core'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Sequelize</code>构造函数的参数介绍</p>
<p><code v-pre>public constructor(database: string, username: string, password: string, options: object)</code></p>
<ul>
<li><code v-pre>database:string</code>:数据库名字</li>
<li><code v-pre>username:string</code>：默认值null，连接数据库用户名</li>
<li><code v-pre>password:string</code>:默认值null，连接数据库密码</li>
<li><code v-pre>options:object</code>选项
<ul>
<li><code v-pre>host：string</code>:默认值localhost，数据库的主机地址</li>
<li><code v-pre>port：number</code>:数据库端口号</li>
<li><code v-pre>username:string</code>：默认值null，连接数据库用户名</li>
<li><code v-pre>password:string</code>:默认值null，连接数据库密码</li>
<li><code v-pre>database:string</code>:数据库名字</li>
<li><code v-pre>hooks:object</code>:在某些生命周期事件之前和之后调用的全局钩子函数的对象。全局钩子将在为同一事件定义的任何特定于模型的钩子之后运行。Init()用于列表)。另外，<code v-pre>beforeConnect()</code>、<code v-pre>afterConnect()</code>、<code v-pre>beforeDisconnect()</code>和<code v-pre>afterDisconnect()</code>钩子可以在这里定义。</li>
<li><code v-pre>dialect:string</code>:要链接数据库的语言下面之一<code v-pre>[mysql, postgres, sqlite, db2, mariadb , mssql]</code></li>
<li><code v-pre>【dialectModule:string，dialectModulePath:string,dialectOptions 】</code>这些用于自定义数据库驱动程序模块很少用</li>
<li><code v-pre>define:object</code>:相当于<code v-pre>Model.init</code> 可以参考 <a href="https://sequelize.org/api/v6/class/src/model.js~Model.html#static-method-init" target="_blank" rel="noopener noreferrer">Model.init<ExternalLinkIcon/></a>.</li>
<li><code v-pre>options.pool:object</code>:连接池的配置选项</li>
<li><code v-pre>options.pool.max:number</code>最大连接数默认5</li>
<li><code v-pre>options.pool.min:number</code>最小连接数默认0</li>
<li><code v-pre>options.pool.idle:number</code>默认10000，十秒，连接在被释放之前可以空闲的最大时间，以毫秒为单位。</li>
<li><code v-pre>options.pool.acquire:number</code>:默认一分钟60000，该池在抛出错误之前尝试获得连接的最大时间(以毫秒为单位)</li>
</ul>
</li>
</ul>
...
<p>在模型中定义的每个列都必须具有数据类型。Sequelize提供了许多内置数据类型。要访问内置数据类型，必须导入<code v-pre>DataTypes</code></p>
<p>字符串类型</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>DataTypes<span class="token punctuation">.</span><span class="token constant">STRING</span>             <span class="token comment">// VARCHAR(255)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>布尔值类型</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>DataTypes<span class="token punctuation">.</span><span class="token constant">BOOLEAN</span>            <span class="token comment">// TINYINT(1)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>数值类型</p>
<div class="language-Js line-numbers-mode" data-ext="Js"><pre v-pre class="language-Js"><code>DataTypes.INTEGER            // INTEGER
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>DataTypes<span class="token punctuation">.</span><span class="token constant">DATE</span>       <span class="token comment">// DATETIME for mysql / sqlite, TIMESTAMP WITH TIME ZONE for postgres</span>
...
<p>模型就是数据库中表的抽象，每个模型都需要继承<code v-pre>Model</code>，模型的定义有两种方式</p>
<ul>
<li><a href="https://sequelize.org/api/v6/class/src/sequelize.js~sequelize#instance-method-define" target="_blank" rel="noopener noreferrer"><code v-pre>sequelize.define(modelName, attributes, options)</code><ExternalLinkIcon/></a></li>
<li><a href="https://sequelize.org/api/v6/class/src/model.js~model#static-method-init" target="_blank" rel="noopener noreferrer"><code v-pre>init(attributes, options)</code><ExternalLinkIcon/></a></li>
</ul>
<p>文档参考地址</p>
<ul>
<li><a href="https://sequelize.org/master/manual/model-basics.html" target="_blank" rel="noopener noreferrer">Model Basics<ExternalLinkIcon/></a></li>
<li><a href="https://sequelize.org/master/manual/model-basics.html" target="_blank" rel="noopener noreferrer">Hooks<ExternalLinkIcon/></a></li>
<li><a href="https://sequelize.org/master/manual/validations-and-constraints.html" target="_blank" rel="noopener noreferrer">Validations &amp; Constraints<ExternalLinkIcon/></a></li>
</ul>
<h3 id="模型的创建" tabindex="-1"><a class="header-anchor" href="#模型的创建" aria-hidden="true">#</a> 模型的创建</h3>
<p>exapmle创建一个用户表</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token punctuation">{</span> Sequelize<span class="token punctuation">,</span> DataTypes <span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'sequelize'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Extend Model创建表</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token punctuation">{</span> Sequelize<span class="token punctuation">,</span> DataTypes<span class="token punctuation">,</span> Model <span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'sequelize'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p>创建模型的注意事项</p>
<p>不要添加同名的字段，否则会移除掉框架提供的getter和setter，从而阻止访问模型的实际数据。</p>
</div>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// Invalid</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="创建模型属性参数" tabindex="-1"><a class="header-anchor" href="#创建模型属性参数" aria-hidden="true">#</a> 创建模型属性参数</h3>
<div class="language-Js line-numbers-mode" data-ext="Js"><pre v-pre class="language-Js"><code>const { Model, DataTypes, Deferrable } = require(&quot;sequelize&quot;);
...
<li><code v-pre>allowNull:boolean</code>允许为空</li>
<li><code v-pre>defaultValue</code>默认值</li>
<li><code v-pre>unique:string|boolean</code>:创建唯一约束，如果值是字符串，则相同字符串的将组合成唯一key</li>
<li><code v-pre>primaryKey：boolean</code>是否为主键</li>
<li><code v-pre>field:string</code>自定义属性名</li>
<li></li>
</ul>
<h3 id="创建模型的options参数" tabindex="-1"><a class="header-anchor" href="#创建模型的options参数" aria-hidden="true">#</a> 创建模型的options参数</h3>
<ul>
<li>
<p><code v-pre>freezeTableName</code>：表明等于模型的名字</p>
<ul>
<li>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>sequelize<span class="token punctuation">.</span><span class="token function">define</span><span class="token punctuation">(</span><span class="token string">'User'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
...
<li>
<p><code v-pre>tableName</code>:指定表名字</p>
</li>
<li>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>sequelize<span class="token punctuation">.</span><span class="token function">define</span><span class="token punctuation">(</span><span class="token string">'User'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
  <span class="token comment">// ... (attributes)</span>
...
<li>
<p><code v-pre>timestamps:boolean</code>：默认值true。默认情况创建模型时会自动给模型添加<code v-pre>createdAt</code>和<code v-pre>updatedAt</code>字段，当创建和更新内容是，该字段也会自动被设置。<strong>(这是sequelize完成的，而不是使用SQL触发器完成，因此直接使用SQL不会导致这些自动自动更新)</strong>。需要禁用就给false</p>
<ul>
<li>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>sequelize<span class="token punctuation">.</span><span class="token function">define</span><span class="token punctuation">(</span><span class="token string">'User'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
  <span class="token comment">// ... (attributes)</span>
...
<li>
<p>也可以只启用createdAt/updatedAt中的一个，并为这些列提供一个自定义名称:</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Foo</span> <span class="token keyword">extends</span> <span class="token class-name">Model</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
...
<h3 id="模型同步" tabindex="-1"><a class="header-anchor" href="#模型同步" aria-hidden="true">#</a> 模型同步</h3>
<p>当定义一个模型时，如果该表不存在，或者表存在但是有不同的列等等与我们的模型有差异时，调用<code v-pre>Model.sync</code>可以使模型与数据库同步。</p>
<ul>
<li><code v-pre>User.sync()</code>表不存在就创建，如果表存在则不执行任何操作</li>
<li><code v-pre>User.sync({force:true})</code>创建表，如果表存在则先删除该表再创建</li>
<li><code v-pre>User.sync({alter:true})</code>检查数据库中表的状态，然后对表执行必要的更改使表与模型匹配</li>
</ul>
<p>如果我们想同步所有的模型可以调用<code v-pre>await sequelize.sync({ force: true })</code></p>
<h3 id="模型删除" tabindex="-1"><a class="header-anchor" href="#模型删除" aria-hidden="true">#</a> 模型删除</h3>
<p>删除某个模型</p>
<ul>
<li><code v-pre>await User.drop();</code></li>
</ul>
<p>删除所有的模型</p>
<ul>
<li><code v-pre>await sequelize.drop();</code></li>
</ul>
<h3 id="安全检查" tabindex="-1"><a class="header-anchor" href="#安全检查" aria-hidden="true">#</a> 安全检查</h3>
<p>对于模型的删除和同步操作是破坏性的，Sequelize接受一个匹配选项正则表达式作为安全检查，只有当表名与正则匹配才会执行后续操作</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//只有当数据库名以'_test'结尾时才会运行sync()</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="属性设置" tabindex="-1"><a class="header-anchor" href="#属性设置" aria-hidden="true">#</a> 属性设置</h3>
<p>1.简写</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>sequelize<span class="token punctuation">.</span><span class="token function">define</span><span class="token punctuation">(</span><span class="token string">'User'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.给默认值</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>sequelize<span class="token punctuation">.</span><span class="token function">define</span><span class="token punctuation">(</span><span class="token string">'User'</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">name</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">type</span><span class="token operator">:</span> DataTypes<span class="token punctuation">.</span><span class="token constant">STRING</span><span class="token punctuation">,</span>
