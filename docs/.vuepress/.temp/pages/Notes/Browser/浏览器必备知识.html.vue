...
<h4 id="cdn什么情况会回源" tabindex="-1"><a class="header-anchor" href="#cdn什么情况会回源" aria-hidden="true">#</a> CDN什么情况会回源</h4>
<p>CDN（Content Delivery Network，内容分发网络）是一种将静态或动态资源分发到全球多个位置的服务，这样可以提高内容的加载速度和可靠性。CDN回源拉取资源的情况通常在以下几种情况下发生：</p>
<ol>
<li><strong>未缓存</strong>：对于没有缓存在CDN节点上的资源，访问者将直接从原服务器上获取资源。这种情况下，CDN会自动回源拉取相应的资源。</li>
<li><strong>缓存过期</strong>：CDN节点上的资源缓存有限制，当缓存过期时，访问者将从CDN节点上获取新的资源。CDN服务器会回源并从原服务器获取新的资源，并将其缓存到CDN节点上。</li>
<li><strong>带宽限制</strong>：在一些情况下，如果CDN节点的带宽有限，可能会回源拉取资源以增加加载速度。如果遇到这种情况，建议与CDN提供商联系，以便他们可以进行调整以提高性能。</li>
<li><strong>缓存策略调整</strong>：CDN服务商会根据实际使用情况和请求模式调整缓存策略。当缓存策略出现变化时，资源可能需要从原服务器进行获取。</li>
</ol>
